...
from spydiff import clean_difmap, import_difmap_model, modelfit_difmap
...
modelfit_difmap(uv_fname, mdl_fname, '0235+164.q1.2008_09_02_delta_fitted.mdl',
                niter=100, path=data_dir, mdl_path=data_dir, out_path=data_dir)
...
comps = import_difmap_model('0235+164.q1.2008_09_02_delta_fitted.mdl', data_dir)
eg1 = comps[0]
# cg2 = comps[1]
cg2 = comps[1]
cg3 = comps[3]
...
mdl.add_components(eg1, cg2, cg3, cg4)
# Create posterior for data & model
lnpost = LnPost(uvdata, mdl, use_V=False, average_freq=True)
ndim = mdl.size
nwalkers = 200
sampler = emcee.EnsembleSampler(nwalkers, ndim, lnpost)
# p_std1 = [0.05, 0.001, 0.001, 0.01, 0.01, 0.01, 0.01, 0.005, 0.005, 0.01]
p_std1 = [0.05, 0.001, 0.001, 0.01, 0.01, 0.01, 0.01, 0.005, 0.005, 0.01] +\
         [0.003, 0.005, 0.005] + [0.003, 0.005, 0.005, 0.001]
p0 = emcee.utils.sample_ball(mdl.p, p_std1, size=nwalkers)
...
corner.corner(sampler.flatchain[::10, :], fig=fig,
              ...
              title_fmt=".3f")
fig.savefig(os.path.join(data_dir, 'q1_corner_mcmc_4components_delta.png'),
...
# nwalkers = 100
# sampler = emcee.EnsembleSampler(nwalkers, ndim, lnpost)
# p_std1 = [0.01, 0.001, 0.001, 0.003, 0.01, 0.05]
# p_std2 = [0.01, 0.001, 0.001, 0.003, 0.01, 0.05]
