...
# clean_difmap(uv_fits, im_fits, 'I', (1024, 0.1), path=data_dir,
...
for i, boot_uv in enumerate(sorted(booted_uv_fits)):
    clean_difmap(boot_uv, 'booted_cc_{}.fits'.format(i), 'I', (512, 1.0),
...
fig = iplot(orig_image.image, error_image.image/(2. * rms), x=orig_image.x,
            y=orig_image.y, show_beam=True, min_abs_level=2*rms, cmap='hsv',
            beam=orig_image.beam, colors_mask=image_mask,
            beam_face_color='black', blc=(230, 225), trc=(420, 370))
fig.savefig('/home/ilya/Dropbox/papers/boot/new_pics/1633_boot_gray.eps',
            bbox_inches='tight', format='eps', dpi=1200)
fig.savefig('/home/ilya/Dropbox/papers/boot/new_pics/1633_boot_gray.svg',
            bbox_inches='tight', format='svg', dpi=1200)
fig.savefig('/home/ilya/Dropbox/papers/boot/new_pics/1633_boot_gray.pdf',
